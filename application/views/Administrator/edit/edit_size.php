	...
	<div class="col-xs-12">
		...
		<div class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" id="name" name="name" placeholder="Size Name" value="<?php echo $selected->name; ?>" class="col-xs-10 col-sm-4" />
					<input name="id" type="hidden" id="id" class="required" value="<?php echo $selected->id; ?>" autofocus="" />
					<span style="size:red;font-size:15px;">
				</div>
			</div>
...
<script type="text/javascript">
	function submit() {
		var name = $("#name").val();
		if (name == "") {
			$("#name").css("border-size", "red");
			return false;
		}
		var id = $("#id").val();
		var inputdata = 'name=' + name + '&id=' + id;
