...
<div id="sales" class="row">
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        <div class="row">
            ...
            <div class="form-group">
                <label for="remainer" class="col-sm-1">Remainder</label>
                <div class="col-sm-2">
                    <input class="form-control" type="date" v-model="sales.reminder_date" />
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-7">
                                    <v-select v-bind:options="customers" @search="inputSearch" label="display_name"
                            ...
                            <div class="form-group" style="display:none;"
                                v-bind:style="{display: selectedCustomer.Customer_Type == 'G' || selectedCustomer.Customer_Type == 'N' ? '' : 'none'}">
                                ...
                                <div class="col-xs-8">
                                    <input type="text" id="customerName" placeholder="Customer Name"
                                        ...
                                        v-bind:disabled="selectedCustomer.Customer_Type == 'G' || selectedCustomer.Customer_Type == 'N' ? false : true" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <textarea id="address" placeholder="Address" class="form-control"
                                        ...
                                        v-bind:disabled="selectedCustomer.Customer_Type == 'G' || selectedCustomer.Customer_Type == 'N' ? false : true"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-5">
                            <form v-on:submit.prevent="addToCart">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8">
                                        <v-select v-if="!isProductFilterByBarcode" id="product"
                                            v-bind:options="products" ref="product" v-model="selectedProduct"
                                            label="display_text" v-on:input="productOnChange"></v-select>
                                        <input v-else type="text" v-model="barcodeValue" placeholder="Barcode"
                                            ref="barcode" class="form-control">
                                    </div>
                                    <div class="col-xs-1" style="padding: 0;">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                    ...
                    <tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
                        ...
                        <tr>
                            <td colspan="3"><textarea style="width: 100%;font-size:13px;" placeholder="Note"
                                    v-model="sales.note"></textarea></td>
                            <td colspan="2" style="padding-top: 15px;font-size:18px;">{{ sales.total_qty}}</td>
...
new Vue({
    ...
    data() {
        return {
            sales: {
                ...
                selling_type: '<?php echo $selling_type; ?>',
                salesType: 'retail',
                salesFrom: '',
                salesDate: '',
                reminder_date: null,
    ...
    watch: {
        'selectedCustomer.Customer_SlNo'(value) {
            // console.log(value);
            if (value == 'C02' && this.NewCustomermobileNo.length == 11) {
                this.selectedCustomer.Customer_Mobile = this.NewCustomermobileNo;
                this.NewCustomermobileNo = ''
            }
        }
    },
    mounted() {
    ...
    methods: {
        inputSearch(search) {
            this.NewCustomermobileNo = search;
        },
        changeProductFilter() {
        ...
        calculateTotal() {
            ...
            this.sales.total_qty = this.cart.reduce((prev, curr) => {
