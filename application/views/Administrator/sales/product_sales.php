							...
							<form v-on:submit.prevent="addToCart">
								<div class="form-group">
									...
									<div class="col-xs-1" style="padding: 0;">
										...
										<a href="#" @click.prevent="changeProductFilter" class="btn btn-xs btn-danger"
                                            style="height: 25px; border: 0; width: 27px; margin-left: -10px;"
                                            target="_blank" title="Add New Product"><i class="fa fa-barcode"
	...
	new Vue({
		...
		methods:{
			...
			async editQuantity(product) {
				var productStock = '';
				await axios.post('/get_product_stock', {productId: product.productId})
				.then(res => {
