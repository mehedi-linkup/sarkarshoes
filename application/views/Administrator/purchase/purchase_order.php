						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								<div class="form-group">
									...
									<div class="col-xs-7">
										<v-select v-bind:options="products" v-model="selectedProduct" label="display_text" id="product" v-on:input="onChangeProduct"></v-select>
									</div>
									<div class="col-xs-1" style="padding: 0;">
								...
								<div class="form-group">
									...
									<div class="col-xs-3">
										<input type="text" min="0" step="1" id="quantity" name="quantity" class="form-control" placeholder="Quantity" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" required/>
									</div>
								</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					...
					<tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
						<tr v-for="(product, sl) in cart">
							...
							<td><input type="number" style="margin: 0; height: 25px;" step="1" min="1" @input="editCart(product)" class="form-control" v-model="product.quantity"></td>
							<td>{{ product.total }}</td>
		...
		methods:{
			...
			addToCart(){
                ...
                if (this.selectedProduct.Product_Purchase_Rate == '') {
                    document.querySelector("#purchaseRate").focus();
                    return
                }
