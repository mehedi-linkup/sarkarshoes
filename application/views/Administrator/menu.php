...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("posSales/product", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>posSales/product">
					<i class="menu-icon fa fa-usd"></i>
					<span class="menu-text"> Pos Sales Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
