						...
						<template scope="{ row }">
							<tr>
								...
								<td>
									...
									<?php }?>
									<!-- <button type="button" target="_blank" class="button" @click="window.location = `/Administrator/products/barcodeGenerate/${row.Product_SlNo}`">
										<i class="fa fa-barcode"></i>
									</button> -->
									<a :href="`/Administrator/products/barcodeGenerate/${row.Product_SlNo}`" type="button" target="_blank" class="barcodeButton">
										<i class="fa fa-barcode"></i>
									</a>
								</td>
							</tr>
	...
	new Vue({
		...
		methods:{
			...
			clearForm(){
				...
				this.product.Product_ReOrederLevel =5;
			}
		}
	})
</script>