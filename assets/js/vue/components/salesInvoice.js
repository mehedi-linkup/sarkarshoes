    ...
    template: `
        <div>
            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-7">
                        <strong>Customer Id:</strong> {{ sales.customerType == 'G' ? 'Cash Customer' :  sales.Customer_Code }}<br>
                        <strong>Customer Name:</strong> {{ sales.customerType == 'G' ? sales.customerName : sales.Customer_Name }}<br>
                        <strong>Customer Address:</strong> {{ sales.customerType == 'G' ? sales.customerAddress : sales.Customer_Address }}<br>
                        <strong>Customer Mobile:</strong> {{ sales.customerType == 'G' ? sales.customerPhone : sales.Customer_Mobile }}
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <ul>
                            <li>Foreign products have no guarantee.</li>
                            <li>Must bring the sales invoice for exchage.</li>
                        </ul>
                    </div>
                </div>
            </div>
